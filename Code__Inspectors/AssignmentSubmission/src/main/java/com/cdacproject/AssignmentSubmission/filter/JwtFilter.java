package com.cdacproject.AssignmentSubmission.filter;
...
public class JwtFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        //Authorization -> [Bearer, asdfgsfs.adaf.afaf][1] =>"asdfgsfs.adaf.afaf" 
        //from array of two string we  get second string and remove White space from start and end
